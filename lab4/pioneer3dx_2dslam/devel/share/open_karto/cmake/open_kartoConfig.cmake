...
if("TRUE" STREQUAL "TRUE")
  set(open_karto_SOURCE_PREFIX /home/student/lab3/pioneer3dx_2dslam/src/open_karto)
  set(open_karto_DEVEL_PREFIX /home/student/lab3/pioneer3dx_2dslam/devel)
  ...
  set(open_karto_INSTALL_PREFIX /home/student/lab3/pioneer3dx_2dslam/install)
...
if(NOT "/home/student/lab3/pioneer3dx_2dslam/src/open_karto/include;/usr/include " STREQUAL " ")
  set(open_karto_INCLUDE_DIRS "")
  set(_include_dirs "/home/student/lab3/pioneer3dx_2dslam/src/open_karto/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'open_karto' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/student/lab3/pioneer3dx_2dslam/src/open_karto/${idir}'.  ${_report}")
    endif()
    _list_append_unique(open_karto_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "karto;/usr/lib/x86_64-linux-gnu/libboost_thread.so.1.71.0")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(open_karto_EXPORTED_TARGETS ${${open_karto_dep}_EXPORTED_TARGETS})
endforeach()
